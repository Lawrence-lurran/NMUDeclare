...
<template>
  <div class="layoutView">
    ...
    <header>
      <div class="header">
        <ul class="nav">
          <li @click="pushRouter('HomePage')">首页</li>
          <li @click="pushRouter('ApplicationForm')">
            成果申请书
            <ul class="second-nav">
              <li>
          ...
          <li>
            ...
            <ul class="second-nav">
              ...
              <li>
                <a href="http://aqjxcg.xupt.edu.cn/cxhd1/cxcy.htm">创新创业</a>
              </li>
              <li>
          ...
          <li>
            ...
            <ul class="second-nav">
              ...
              <li>
                <a href="http://aqjxcg.xupt.edu.cn/pycx/yxxy.htm">优秀校友</a>
              </li>
            </ul>
          </li>
        </ul>
